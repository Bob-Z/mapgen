...
def process(entity, osm_data=None):
    ...
    if "leisure" in entity.tags:
        if entity.tags["leisure"] == "park":
            create_from_entity(osm_data, entity, height=gvar.GROUND_LEVEL + config.data["park_height"],
                               z=-gvar.GROUND_LEVEL,
        ...
        for member in entity.members:
            ...
            if way is not None:
                if member.role == "outer":
                    ...
                    object_3d.create_all_object_file(way.nodes, height=config.data["island_height"], z=z,
